 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Driver [C:\\Users\\TBrecke_PC\\.wdm\\drivers\\chromedriver\\win32\\100.0.4896.60\\chromedriver.exe] found in cache\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    hemi_img = hemi_soup.find('li').a.get('href')\n",
    "    \n",
    "    hemispheres = {}\n",
    "    hemispheres[\"hemi_img\"] = f'https://marshemispheres.com/{hemi_img}'\n",
    "    hemispheres[\"hemi_title\"] = hemi_title\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "[{'hemi_img': 'https://marshemispheres.com/images/full.jpg',\n",
       "  'hemi_title': 'Cerberus Hemisphere Enhanced'},\n",
       " {'hemi_img': 'https://marshemispheres.com/images/schiaparelli_enhanced-full.jpg',\n",
       "  'hemi_title': 'Schiaparelli Hemisphere Enhanced'},\n",
       " {'hemi_img': 'https://marshemispheres.com/images/syrtis_major_enhanced-full.jpg',\n",
       "  'hemi_title': 'Syrtis Major Hemisphere Enhanced'},\n",
       " {'hemi_img': 'https://marshemispheres.com/images/valles_marineris_enhanced-full.jpg',\n",
